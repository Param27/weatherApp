...
import com.techmyriad.weatherapp.adapter.RecyclerViewAdapter;
import com.techmyriad.weatherapp.database.DatabaseQuery;
import com.techmyriad.weatherapp.entity.WeatherObject;
import com.techmyriad.weatherapp.helper.CustomSharedPreference;
import com.techmyriad.weatherapp.helper.Helper;
import com.techmyriad.weatherapp.json.FiveDaysForecast;
import com.techmyriad.weatherapp.json.FiveWeathers;
import com.techmyriad.weatherapp.json.Forecast;
...
public class WeatherActivity extends AppCompatActivity implements LocationListener {
            ...
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (locationManager != null) {
                        ...
                        apiUrl = "http://api.openweathermap.org/data/2.5/weather?lat=51.5074&lon=0.1278&APPID=55e1ef2356c6e8084635491b939c5ec8&units=metric";
                        makeJsonObject(apiUrl);
                    }
                }
            }else{
    ...
    private void fiveDaysApiJsonObjectCall(String city){
        String apiUrl = "http://api.openweathermap.org/data/2.5/forecast?q="+city+ "&APPID=55e1ef2356c6e8084635491b939c5ec8&units=metric";
